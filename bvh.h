...
public:
  ...
  void renderGL( mat4 &WCS_to_CCS ) {
    if (root != NULL)
      renderSubtreeGL( root, WCS_to_CCS, scene->bvhDisplayDepth );
  }
  ...
  void renderSubtreeGL( BVH_node *root, mat4 &WCS_to_CCS, int levelsRemaining );
